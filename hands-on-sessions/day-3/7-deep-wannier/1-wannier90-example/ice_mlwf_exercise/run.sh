...
## run a SCF DFT calculation. DO NOT mpirun directly, call /usr/bin/mpirun instead. The default mpirun on our virtual machine is somehow not doing parallelism at all. 
